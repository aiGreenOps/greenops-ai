            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.main}>
                ...
                <View style={styles.achievementsCard}>
                    ...
                    <View style={styles.badgesGrid}>
                        {[
                            { label: 'Sharp Observer', icon: '👀', bg: '#e0f2fe' },       // più lungo ma compatto
                            { label: 'Quick Reporter', icon: '🕒', bg: '#fef9c3' },       // invariato
                            { label: 'Loyal Reporter', icon: '📌', bg: '#ecfdf5' },
                            { label: 'Green Guardian', icon: '🌿', bg: '#f5f3ff' },       // invariato
                        ].map((badge, i) => (
